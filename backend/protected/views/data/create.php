<main class="p-6">
	...
	<div class="flex justify-between items-center mb-6">
		<h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Tambah Data Baru</h4>
		...
		<div class="md:flex hidden items-center gap-2.5 font-semibold">
			...
			<div class="flex items-center gap-2">
				...
				<a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Tambah Data Baru</a>
			</div>
		</div>
	</div>
	<!-- Page Title End -->
			...
			<div class="card-body p-3 h-screen">
				...
				?>
					...
					<div class="mb-3">
						...
						<?php echo $form->dropDownList($model, 'subjek',$optionSubjek,array("empty"=>":: Pilih Subjek ::","class"=>"form-input")); ?>
					...
					<div class="mb-3">
						<?php echo CHtml::submitButton('Tambah Data',array("class"=>"btn w-full bg-primary text-white")); ?>
                    </div>
				<?php $this->endWidget(); ?>
			</div>
		</div>
