<main class="p-6">
	...
	<div class="flex justify-between items-center mb-6">
		<h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Tambah Publikasi Baru</h4>
		...
		<div class="md:flex hidden items-center gap-2.5 font-semibold">
			...
			<div class="flex items-center gap-2">
				...
				<a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Tambah Publikasi Baru</a>
			</div>
		</div>
	</div>
	<!-- Page Title End -->
			...
			<?php
				...
				?>
					...
					<div class="mb-3">
						...
						<?php echo $form->textArea($model, 'abstraksi',array("class"=>"form-input",'rows' => 6, 'cols' => 50)); ?>
