<?php
    ...
    if(isset($_GET['id'])){
        $id=(int)$_GET['id'];
        $analisis=getById("analisis",$id);
        if($analisis){
            $data=json_decode($analisis);
        } else {
                            ...
                            <div class="product-details__thumb-slider border border-gray-100 rounded-16">
                                <div class="">
                                    <div class="product-details__thumb flex-center">
                                        <?php echo ( isset($data->image) ? "<img src='".$data->image[0]->signedUrl."' alt='".$data->judul."' />" : "<image src='assets/images/analisis-no-images.png' alt='no-image' />");?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-details__content">
                            ...
                            <div class="flex-between gap-16 flex-wrap">
                                <div class="flex-align flex-wrap gap-16">
                                    <div class="button">
                                        <a id="read" class="btn btn-main rounded-8 flex-align d-inline-flex gap-8 px-24"> Baca Analisis <i class="ph-fill ph-book"></i></a> 
                                    </div>
                                    <div class="button">
